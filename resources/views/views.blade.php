                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <label for="nama" class = "col-sm-2 input-group-text">Nama</label>
                            <div class = "col-sm-10">
                        ...
                        <div class="input-group mb-3">
                            <label for="jabatan" class = "col-sm-2 input-group-text">Jabatan : </label>
                            <div class = "col-sm-10">
                        ...
                        <div class="input-group mb-3">
                            <label for="umur" class = "col-sm-2 input-group-text">Umur : </label>
                            <div class = "col-sm-10">
                        ...
                        <div class="input-group mb-3">
                            <label for="alamat" class = "col-sm-2 input-group-text">Alamat : </label>
                            <div class = "col-sm-10">
